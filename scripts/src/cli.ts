...
export function optionFlag(options: ParsedOptions, name: string): boolean {
  return options.get(name) === true;
}

export function requireSinglePositional(positionals: readonly string[], usage: string): string {
