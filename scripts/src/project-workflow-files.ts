...
function briefFile(profile: ScaffoldProfile, authorization?: GenerativeAssetAuthorization): string {
...
const RESEARCH_FILES: Readonly<Record<string, string>> = {
...
const STRATEGY_FILES: Readonly<Record<string, string>> = {
...
export function createWorkflowFiles(
  profile: ScaffoldProfile = "neutral",
