...
import { createWorkflowFiles, } from "./project-workflow-files.js";
...
async function copyTemplate(source, destination, targetRoot) {
    let copied = 0;
...
async function writeWorkflowFiles(target, profile, authorization) {
    const created = [];
    const preserved = [];
