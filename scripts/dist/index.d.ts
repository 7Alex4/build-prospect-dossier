export { auditOutput, type AuditedPage, type AuditOutputOptions, type OutputAuditReport, } from "./output-audit.js";
export { type ExpectedPdfSource, type PdfAuditReport, type PdfPageAudit, } from "./pdf-output-audit.js";
...
export { prepareLogo, type LogoReport, type PrepareLogoOptions } from "./logo-processing.js";
