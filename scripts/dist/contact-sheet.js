...
import { IMAGE_CONCURRENCY, mapWithConcurrency, MAX_IMAGE_FILES, MAX_IMAGE_PIXELS, UserInputError, } from "./core.js";
...
export async function createContactSheet(items, outputPath, title) {
