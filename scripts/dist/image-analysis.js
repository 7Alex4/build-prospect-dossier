...
import { MAX_IMAGE_BYTES, MAX_IMAGE_PIXELS, round, sha256File, toPosixPath, UserInputError, } from "./core.js";
function displayedDimensions(width, height, orientation) {
...
async function measurePalette(filePath, limit) {
...
export async function analyzeImage(filePath, rootDirectory, paletteLimit) {
